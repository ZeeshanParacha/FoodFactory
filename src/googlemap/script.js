...
const map, _map, myLocation;
const infoWindow;
const pos = {lat: 22.990537, lng: 120.171127};
const currentLocation;
const planRouteMode;
const markerCluster;
// Create an array of alphabetical characters used to label the markers.
const markerLabels = "ＡＢＣＤＥＦＧＨＩＪＫＬＭＮＯＰＱＲＳＴＵＶＷＸＹＺ";
const locations = [], placeNames = [], placeVicinitys = [], markers = [];
const ratingColor = ["gray", "darkgreen", "lightgreen", "yellow", "orange", "red"];
...
function getLocation(func, closeCurrentContent) {
    ...
    if (navigator.geolocation) {
        navigator.geolocation.getCurrentPosition(position => {
            ...
            currentLocation = pos;
            myLocation.innerHTML = "Your Location: (" + pos.lat + ", " + pos.lng + ")";
            ...
            infowindow = new google.maps.InfoWindow({
                content: placeContentString("Current location", "")
            });
